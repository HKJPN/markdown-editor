...
MD//WORKS is designed to minimize unnecessary network communication and server-side risk. However, it is an open-source personal project and has not undergone a formal third-party security audit.Dependency security updates are reviewed and applied on a best-effort basis. Users should independently verify whether the current version meets their own security requirements.
