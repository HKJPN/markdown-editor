...
1. タイトルバーの **共有**ボタンをタップします。   <img src="./images/share-ja.jpg" alt="share" width="90" style="float: right; margin-left: 15px;"><br>
   または、メニューバーの **ファイル > 共有（⌘S）** を選択します。
3. 「ファイル」アプリから必要に応じて保存先を選択します。<br><img src="./images/SaveToFiles-J.jpg" alt="SaveToFiles" width="300" style="float: right; margin-left: 15px;">
