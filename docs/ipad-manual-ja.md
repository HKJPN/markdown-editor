...
| :--- | :--- | :--- | :--- | :--- |
| **MD//WORKSとのAI連携** | 🚫 サイドバーが表示されるもののコピーペースト主体 | ✅ 文構造全体又は選択領域の解析可能　 | ✅　文構造全体の解析可能 | 🚫 サイドバーが表示されるもののコピーペースト主体 |
...
| **セキュリティ** | MS 365環境に最適/　**✅ローカル可** | Google Workspace設定に依存/　**✅ローカル可**  | データ送信の最小化・ローカル優先/　**✅ローカル可** | Block AI（AIの強制禁止） /　**✅ローカル可** |
