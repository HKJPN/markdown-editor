...
1.  **Tap the Share button** <img src="./images/share-e.jpg" alt="share" width="60"> located in the title bar. Alternatively, you can go to **File > Share** in the menu bar, or press `⌘ + S` on your keyboard. <img src="images/SaveToFiles-e.jpg" width="120" align="right">
...
> **Note:**
> Make sure to tap the Share button **inside the editor's title bar**🚫<img src="images/DoNotTapBrowserShareBottons.jpeg" width="30">, NOT the browser's share button at the top or bottom of the screen. You cannot save a Markdown file using the browser's share menu.
> 
...
The Deep Edit log can be used not only for reviewing the editing process yourself, but also for having a browser AI capable of referencing screen content, such as Leo in Brave Browser on iPad, analyze your writing process from an objective third-party perspective.
...
#### 12-1-1. Brave Browser: Using Leo
