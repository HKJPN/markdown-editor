...
No. All editing and saving operations are completed within your browser. Your documents are not uploaded to the cloud. See [the mmanual](https://github.com/HKJPN/markdown-editor/blob/main/docs/manual.md#for-strict-security-and-corporate-policies) for more detail.
