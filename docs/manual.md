...
#### 1-1-1. Steps to Create an App and Switch with Browser Tabs for Chrome<img src="./images/GoogleIcon.jpg" alt="Image:icon" width="20">. <br>For other browsers<img src="./images/SafariIcon.png" alt="Image:icon" width="20"> <img src="./images/BraveIcon.jpg" alt="Image:icon" width="16"> <img src="./images/EdgeIcon.png" alt="Image:icon" width="16">, please refer to Appendix 4  
