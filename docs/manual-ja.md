...
他のブラウザをお使いの場合は[付録5：各種ブラウザでのアプリ化とアンインストール法](#appendix-5-other-browsers)をご覧ください。
...
#### 11-1-3. ローカルLLM
**インターネットにデータを一切送信せずに、「完全ローカルLLM」を構築**することも可能です。構築手順については、**本書の[「付録1と2」](#appendix-1-2-local-llm)を**ご参照ください。
