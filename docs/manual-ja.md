...
```
## 付録6. Markdown文書をWordで使用する

### 付録6-1. プレビューからコピーする簡単な方法

一時的にWordで使用するだけであれば、`.md`ファイルを直接変換する必要はありません。
...
一時的な利用にはこの方法が便利です。文書全体を正式な`.docx`ファイルへ変換する場合は、次に説明するPandocを使用してください。

### 付録6-2. Pandocで.docxへ変換する方法
