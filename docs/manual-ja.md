...
## 12. 付録：画像差し込み用の撮影チェック

画像付き説明書として仕上げる場合は、次の画面を優先して撮影すると、本文に差し込みやすくなります。

| 図番号 | 撮影内容 | 対応章 |
| --- | --- | --- |
| 図1 | 画面全体。①〜⑥の番号付き | 1-3 |
| 図2 | ファイルメニューの新規作成・開く・Wordファイルを開く | 2 |
| 図3 | エディターへのMarkdown入力例 | 3 |
| 図4 | ツールバー全体 | 4 |
| 図5 | Preview ONの2カラム表示 | 5 |
| 図6 | 保存ボタンとSaved / Unsaved表示 | 6 |
| 図7 | ファイルメニューのスタンドアロン保存・暗号化App・HTML・PDF | 7 |
| 図8 | 検索・置換パネル | 8 |
| 図9 | 表示メニュー全体 | 9 |
| 図10 | アウトライン表示 | 9-2 |
| 図11 | 不可視文字を表示した状態 | 9-3 |
| 図12 | Spell (EN) パネル | 9-6 |
| 図13 | ヘルプメニュー | 10 |
| 図14 | Keyboard Shortcuts画面 | 10-2 |
| 図15 | よくあるトラブル用のUnsaved表示 | 11-2 |
