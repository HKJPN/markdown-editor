...
| **AIモデルの選択** |  🚫不可 |  🚫 不可 | **✅ 可**  |  **✅ 可**  |
| **設計思想** | MS 365・組織ポリシー重視 | 柔軟なAI対話・利便性重視 | プライバシー・ユーザー制御重視|  安全性・ユーザー制御重視 |
...
MD//WORKSでの検証では、Gemini in ChromeはとBrave(Leo)は本エディタの画面構造に対してスムーズに動作し、文書全体の校正、要約、用語ゆれ確認、構成レビューなどに加え、限定した領域の言いかえ等のに活用できます。執筆支援機能を全般を積極的に使いたい方におすすめです。
