...
* Codexに渡す実装指示文として、編集中の仕様を整理して

#### 長文のリライト支援として

各社上位AIモデル（フロンティアモデル）をお使いの場合は、短い文書だけでなく数万~十万文字全文を対象としたリライト支援も可能であることを確認しています。付録## 5.に参考となるプロンプト例をまとめました。
...
---
以下に、レビュー対象とするプロシーディングのテキスト（各章）を貼り付けてください。
