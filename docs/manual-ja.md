...
文書の作成、Markdowのプレビュー表示、ファイル保存、HTML/PDF書き出し、スタンドアロンHTMLとしての保存、ブラウザAIに対応しています。
...
>多数の画像を取り込みには[image2md.py](https://github.com/HKJPN/images2md/tree/main)を別途のコマンドラインツールとしてご用意しました。プレゼンテーションの配布資料やレポートの作成など、多数の写真を一度に取り込む際に併用ください。
