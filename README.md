...
* <img src="./images/icon2.png" alt="Image:icon" width="30"> **App Launch Icon**: Added a dedicated app icon for a more native app-like experience, and updated the manual with detailed installation instructions.
