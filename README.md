...
We've also included two standalone command-line tools that instantly compile large batches of images into a files. This significantly streamlines your MD//WORKS workflow when creating image-heavy reports or handouts.
