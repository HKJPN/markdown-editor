...
**MD//WORKS**は、インストールもクラウドも不要なエディタです。ブラウザさえあれば、手元の端末だけで「安全に持ち運べるアプリ」のように文章を管理できます。もちろん、**すべてローカルで処理**されます。さらに、**高度なブラウザAI連携**によりブラウザ標準の**AIサイドバー**の活用も可能です。**「文章の校正」**  や **「翻訳」** はもちろん文章 **「全体の構成案」** 等 をAIにコピペなしで指示し、秒速で返答が得られ本来の執筆に集中することができます。
