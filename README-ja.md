...
* **📱 iPad向け 取扱説明書(完全版)**
* **Scientific Writing Guide（完全版)**
* iPadOS全画面表示におけるUI被り（×ボタン干渉）の解消
...
* **更にプライバシーを確保したい場合:** 各AIアシスタントを制御禁止できるブラウザをご使用いただくことで、より安全なエディタとして機能します。詳細は[取扱説明書の「11. AI支援執筆」](https://github.com/HKJPN/markdown-editor/blob/main/docs/manual-ja.md#11-ai%E6%94%AF%E6%8F%B4%E5%9F%B7%E7%AD%86--)をご覧ください。
