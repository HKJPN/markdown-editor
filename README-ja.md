...
**MD//WORKS**は、インストールもクラウドも不要なエディタです。ブラウザさえあれば、手元のパソコンだけで「安全に持ち運べるアプリ」のように文章を管理できます。もちろん、すべてローカルで処理されます。さらに、**高度なブラウザAI連携**によりブラウザの**AIサイドバー**も活用できます。**「文章の校正」**  や **「翻訳」** はもちろん文章 **「全体の構成案」** 等 をAIにコピペなしで指示し、秒速で完了します。
