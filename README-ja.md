...
今回のリリースではエクスポート機能が**劇的に進化**！これまで以上に安全かつ柔軟なドキュメント出力が可能になりました。

* 🔒 **大切なドキュメントを保護**:新しく追加された「**制限付き**」 および「**パスワード保護**付き」のビューアー出力機能により、第三者による不正アクセスや無断コピーを抑制します。
* ⚡ **より直感的でスピーディーな出力**:新しく整理された専用のエクスポート画面から、目的に合った最適なフォーマットを迷わず瞬時に選択できます。
* 🛠️ **メニューバーの利便性アップ**:最新バージョンの通知機能を追加しました。現在のバージョンと最新バージョンがひと目で確認でき、最新のリリース・ページへのアクセスもよりスムーズに行えます。
