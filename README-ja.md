...
## 💡コンパニオンツールも用意
大量画像も秒でマークダウンファイルに取り込む[image2md.py](https://github.com/HKJPN/images2md/tree/main)を別途用意しました。プレゼンテーション配布資料の作成や写真の多いレポートの作成等、コマンドラインを併用することで、MD//WORKSのワークフローを更に効率的に。
