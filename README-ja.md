...
**MD//WORKS**は、インストールもクラウドも不要なエディタです。ブラウザさえあれば、手元のパソコンだけで「安全に持ち運べるアプリ」のように文章を管理できます。もちろん、すべてローカルで処理されます。さらに、**高度なブラウザAI連携**によりChromeやBraveの**AIサイドバー**も活用できます。**「文章の校正」や「翻訳」** をAIにコピペなしで指示し、秒速で完了します。
