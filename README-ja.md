...
パスワードで保護したAppsも **File > Open**から直接開けるようになりました。これにより MD//WORKS でサポートされている全ての形式のファイルは同じ**File > Open**メニューから同じように開けるようになりました。もちろん、自己展開ファイルは自己展開形式でも開けることは、いままで通りサポートされています。
