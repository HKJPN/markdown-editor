# 🚀 MD//WORKS v1.6.3 — AIアシスタント融合スタンドアロン Markdown エディタ![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)
...
# 🎉 v1.6.3の新機能とアップデート — 複数文書を、もっと安心して編集

### マルチタブ編集を強化

* 複数の文書をタブごとに独立して編集でき、**Auto Saveと作業履歴もそれぞれ安全に管理**されます。
* ブラウザを閉じても作業履歴を保持。再起動時には、**これまでの履歴をまとめて確認・復元**できます。
* タブには現在のファイル名を表示し、複製したタブも独立したWorkspaceとして安全に扱います。

### 日常の編集操作も改善

* 検索パネルを閉じてもハイライトを保持し、もう一度 **Esc** を押すと解除できます。
* Deep Edit Mode、見出し等の挿入操作、保護HTMLファイルの判定も改善しました。
