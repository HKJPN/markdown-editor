...
### 🎓 派生プロジェクト：教育機関向け「Academic MD//WORKS」

MD//WORKSの「執筆プロセスを記録する」技術を応用し、レポート課題向けの別プロジェクト「Academic MD//WORKS」も準備中です。
...
- マルチタブでは作業履歴をタブごとに管理し、再起動時には保存された履歴をまとめて確認・復元できます。
