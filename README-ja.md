# 🚀 MD//WORKS v1.5.5 — AIアシスタント融合スタンドアロン Markdown エディタ![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)
...
* **ペースト時の挙動安定化**：ペースト時の判定を見直し、長文でも安定して貼り付けられるように改良を予定しています。 
* **目次の作成** ：目次を自動的に作成できる機能を予定しています。
...
* **更にプライバシーを確保したい場合:** **Firefox*など、各AIアシスタントを制御できるブラウザをご使用いただくことで、より安全なエディタとして機能します。詳細は[取扱説明書の「11. AI支援執筆」](https://github.com/HKJPN/markdown-editor/blob/main/docs/manual-ja.md#11-ai%E6%94%AF%E6%8F%B4%E5%9F%B7%E7%AD%86--)をご覧ください。
...
Chrome / Edge / Brave /Firefox / Safari などのモダンブラウザで動作。  
インストール不要。HTML ファイルを開くだけで利用できます。デスクトップ環境はもちろん、iPad等のタブレットでも動作確認を行っています。
